...
_cache_size_limit: int = 10 * 1024**3
_cache_ttl: int = 604800
_cache_shards: int = 8
...
def pdf_to_text_bytes(pdf_bytes):
    ...
    pm_logger = _logging.getLogger("pdfminer")
    pm_logger.setLevel(_logging.ERROR)
